...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.inzynierka.esports.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.inzynierka.esports.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.inzynierka.esports.domain.Game.class.getName());
            createCache(cm, com.inzynierka.esports.domain.Game.class.getName() + ".tournaments");
