...
import { MatchesComponent } from 'app/entities/matches/matches.component';
import { MatchesService } from 'app/entities/matches/matches.service';
import { Matches } from 'app/shared/model/matches.model';

describe('Component Tests', () => {
  describe('Matches Management Component', () => {
    let comp: MatchesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MatchesComponent, '')
        .compileComponents();
