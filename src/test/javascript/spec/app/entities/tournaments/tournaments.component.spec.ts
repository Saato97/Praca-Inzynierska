...
import { TournamentsComponent } from 'app/entities/tournaments/tournaments.component';
...
describe('Component Tests', () => {
  describe('Tournaments Management Component', () => {
    let comp: TournamentsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TournamentsComponent, '')
        .compileComponents();
