...
import { OrganizersComponent } from 'app/entities/organizers/organizers.component';
...
describe('Component Tests', () => {
  describe('Organizers Management Component', () => {
    let comp: OrganizersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrganizersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.organizers && comp.organizers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
