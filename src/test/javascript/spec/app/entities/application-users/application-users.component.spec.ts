...
import { ApplicationUsersComponent } from 'app/entities/application-users/application-users.component';
...
describe('Component Tests', () => {
  describe('ApplicationUsers Management Component', () => {
    let comp: ApplicationUsersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplicationUsersComponent, '')
        .compileComponents();
